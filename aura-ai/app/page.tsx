          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-[45%] relative h-[400px] md:h-[500px]">
              ...
              <div className="absolute top-0 right-0 w-[85%] h-[90%] bg-border-dark rounded-lg overflow-hidden shadow-sm">
                <img src="https://images.unsplash.com/photo-1580618672591-eb180b1a973f?q=80&w=800&auto=format&fit=crop" alt="Luxury Salon Interior" className="w-full h-full object-cover" />
              </div>
              {/* Supporting Image */}
